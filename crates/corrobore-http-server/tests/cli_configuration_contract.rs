...
fn status_reports_ready_when_operational_contract_is_compatible() {
    ...
    let fixture = spawn_operational_fixture(
        listener,
        r#"{"service":"corrobore-http-server","version":"0.3.0","commit":"fixture","build_target":"test","storage_compatibility":{"supported_versions":["V1"],"supported_record_formats":["JsonLinesV1"],"active_storage_version":null,"active_record_format":null}}"#,
    );
